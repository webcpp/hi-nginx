...
namespace hi
{
    ...
    {
    public:
        lua(const std::string &package_path, const std::string &package_cpath) : error_message("<p style='text-align:center;margin:100px;'>Server script error</p>"), res(0), state()
        {
