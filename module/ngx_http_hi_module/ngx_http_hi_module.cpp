...
ngx_command_t ngx_http_hi_commands[] = {
    ...
    {ngx_string("hi_qjs_memory_limit"),
     ...
     NULL},
    {ngx_string("hi_qjs_stack_limit"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_SIF_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_size_slot,
     NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_hi_loc_conf_t, qjs_stack_limit),
     NULL},
...
static void *ngx_http_hi_create_loc_conf(ngx_conf_t *cf)
{
    ...
    if (conf)
    {
        ...
        conf->qjs_stack_limit = NGX_CONF_UNSET_SIZE;
...
static char *ngx_http_hi_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_size_value(conf->qjs_stack_limit, prev->qjs_stack_limit, (size_t)1048576 * 8);
...
static ngx_int_t ngx_http_hi_normal_handler(ngx_http_request_t *r)
{
    ...
    {
    case application_t::__cpp__:
        hi::ngx_http_hi_cpp_handler(r, conf, ngx_request, ngx_response);
        break;
#ifdef HTTP_HI_PYTHON
    case application_t::__python__:
        hi::ngx_http_hi_python_handler(r, conf, ngx_request, ngx_response);
        break;
#endif
#ifdef HTTP_HI_QJS
    case application_t::__qjs__:
        hi::ngx_http_hi_qjs_handler(r, conf, ngx_request, ngx_response);
        break;
#endif
#ifdef HTTP_HI_LUA
    case application_t::__lua__:
        hi::ngx_http_hi_lua_handler(r, conf, ngx_request, ngx_response);
        break;
#endif
#ifdef HTTP_HI_JAVA
